About confluence-markdown-exporter-feedstock
============================================
...
pixi add confluence-markdown-exporter
# for installing globally
pixi global install confluence-markdown-exporter
```
...
It is possible to list all of the versions of `confluence-markdown-exporter` available on your platform:
...
```
pixi search confluence-markdown-exporter --channel conda-forge
```
